...
export const metadata = {
  title: "Designer Trade Program — House of Decór",
  description: "Exclusive trade benefits for interior design professionals. Partner with House of Decór for premium handmade rugs and bespoke curtains.",
};
