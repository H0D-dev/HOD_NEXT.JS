...
export const metadata = {
  title: "Know Your Rug — House of Decór",
  description: "Discover the craftsmanship behind House of Decór. Learn about weaving techniques, premium fibers, and the meticulous rug-making process.",
};
