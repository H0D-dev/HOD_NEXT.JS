...
export default function TradeCTA() {
  return (
    <section className="w-full py-32 md:py-48 px-6 md:px-16 lg:px-24 bg-[#0D0D0D] text-white">
      <div className="max-w-[var(--container-md)] mx-auto text-center flex flex-col items-center">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-7xl leading-[1.1] tracking-tight mb-8">
            Ready to begin your design journey?
          </h2>
          <p className="font-sans text-[#D0D0D0] text-lg md:text-xl leading-relaxed mb-16 max-w-xl">
            Partner with House of Décor and gain exclusive access to our premium handmade rugs, bespoke curtains, and unparalleled trade benefits. Let us elevate your next interior project.
          </p>
