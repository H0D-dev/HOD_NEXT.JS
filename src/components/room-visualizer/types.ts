...
export type VisualizerState = {
  ...
  floorTextureStrength: number; // 0–1: how much floor texture bleeds into the rug
  wandTolerance: number;       // 0–100: color tolerance for magic wand flood fill
  wandContiguous: boolean;      // true = flood fill contiguous region, false = fill all matching pixels
