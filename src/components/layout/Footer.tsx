...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#111111] text-white pt-20 lg:pt-32 pb-8 border-t border-[#333333]">
      <div className="max-w-[var(--container-lg)] mx-auto px-6">
        ...
        {/* BOTTOM BAR */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-[#333333] gap-6">
