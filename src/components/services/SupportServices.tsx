    ...
    <section className="w-full py-24 md:py-32 px-6 md:px-16 lg:px-24 bg-[var(--bg-primary)]">
      <div className="max-w-[var(--container-lg)] mx-auto flex flex-col gap-24 lg:gap-32">
        ...
        >
          ...
          <p className="font-serif text-2xl md:text-3xl text-[var(--text-primary)] italic leading-relaxed mt-4 border-l-4 border-[var(--accent-primary)] pl-6 text-left">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 border-t border-[var(--border-secondary)] pt-24"
        >
          {supportServices.map((service, idx) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h4 className="font-sans font-medium text-[var(--text-primary)] text-lg mb-3">
                    {service.title}
                  </h4>
