            ...
            >
              ...
              <div className="relative w-full aspect-[4/3] overflow-hidden bg-[var(--bg-secondary)] mb-6">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <h3 className="font-sans text-white text-[10px] md:text-xs tracking-widest uppercase">
                    {cat.title}
                  </h3>
                </div>
              </div>
              ...
              {/* Description Text */}
              <p className="text-[10px] md:text-xs font-light text-[var(--text-secondary)] leading-relaxed mt-1">
                {cat.desc}
              </p>
            </Link>
          ))}
