          ...
          {images.length > 1 && (
            <>
              <button
                ...
                className="absolute left-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/20 backdrop-blur-md hover:bg-black/40 rounded-full flex items-center justify-center text-white z-20 transition-all cursor-pointer"
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-black/20 backdrop-blur-md hover:bg-black/40 rounded-full flex items-center justify-center text-white z-20 transition-all cursor-pointer"
