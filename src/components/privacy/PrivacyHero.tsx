        ...
        >
          ...
          <div className="flex flex-col gap-8 text-center max-w-2xl mx-auto">
            <p className="font-sans text-[var(--text-secondary)] text-sm sm:text-base leading-relaxed font-light max-w-lg mx-auto">
              At House of Decor LLC (“House of Decor,” “we,” “our,” or “us”), we are committed to protecting your privacy and ensuring that your personal information is handled responsibly. This Privacy Policy explains how we collect, use, disclose, and protect your information when you visit www.houseofdecor.ae, contact us, or use our products and services.
            </p>
            <p className="font-sans text-[var(--text-secondary)] text-sm sm:text-base leading-relaxed font-light max-w-lg mx-auto">
