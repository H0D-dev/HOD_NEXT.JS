...
export default function ContactHero() {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-[70vh] lg:h-screen flex flex-col justify-end lg:justify-center overflow-hidden bg-black" id="contact-hero-section">
