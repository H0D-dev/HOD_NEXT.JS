...
export default function ProcessSection() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-[var(--bg-tertiary)] pt-8 md:pt-12 pb-24 md:pb-32" id="process-section">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="mb-16 md:mb-24 flex flex-col items-start max-w-3xl">
          ...
          <h2 className="text-[clamp(32px,6vw,72px)] font-light leading-tight tracking-tight text-[var(--text-primary)]">
        ...
        <div className="relative flex flex-wrap md:flex-nowrap justify-between items-stretch gap-4 md:gap-6" ref={wrapperRef}>
          ...
          {steps.map((step) => {
            ...
            return (
              <div key={step.id} className="relative z-10 flex flex-col items-center justify-center w-[calc(50%-8px)] md:flex-1 bg-[var(--surface-primary)] border border-[var(--border-secondary)] rounded-none p-5 md:p-6 min-h-[140px] md:min-h-[160px] group cursor-pointer hover:border-[var(--border-primary)] transition-colors duration-500">
                ...
                {/* Step Number */}
                <span className="text-[var(--text-muted)] text-[10px] uppercase tracking-widest mb-1 transition-colors duration-500 group-hover:text-[var(--text-primary)]">
                  {step.id}
                </span>

                {/* Step Title */}
                <h3 className="text-xs text-[var(--text-primary)] uppercase tracking-widest text-center transition-colors duration-500 group-hover:text-[var(--accent-primary)]">
                  {step.title}
                </h3>
