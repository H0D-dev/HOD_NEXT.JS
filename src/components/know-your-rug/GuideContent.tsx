...
export default function GuideContent() {
  return (
    <section className="w-full py-24 md:py-32 px-6 md:px-16 lg:px-24 bg-[var(--bg-secondary)] border-b border-[var(--border-secondary)]">
      <div className="max-w-[var(--container-lg)] mx-auto flex flex-col gap-24 lg:gap-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h4 className="font-serif text-2xl text-[var(--text-primary)]">Lighting Conditions</h4>
            <p className="font-sans text-[var(--text-secondary)] text-lg leading-relaxed">
          ...
          >
            ...
            <h4 className="font-serif text-2xl text-[var(--text-primary)]">On-Screen vs. Real Life</h4>
            <p className="font-sans text-[var(--text-secondary)] text-lg leading-relaxed">
